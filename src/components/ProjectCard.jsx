...
const ProjectCard = ({ image, title, category }) => {
    return (
        <Flex className='w-sm flex-col items-center bg-white py-5 rounded-2xl shadow-2xl relative group/item'>
            <Flex className='w-xs h-52 bg-light justify-center items-center rounded-2xl'>
                <div className='w-xs mx-auto h-52 bg-light rounded-2xl p-4'>
            ...
            <Flex className='justify-center items-center gap-x-2'>
                <p className='text-xl text-paralight font-normal'>{category}</p>
