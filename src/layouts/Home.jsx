...
const Home = () => {
  return (
    <>
      {/* Hero Section here*/}
      <section id='home' className="flex flex-col items-center py-10 pt-40 bg-light">
        <Container>
          <Flex className='gap-x-5 items-center'>
            ...
            <div className="my-10 text-center">
              <h1 className="text-4xl font-bold mb-5">          Hi, I'm Farjana
                Akter... <span className="inline-block">👋</span></h1>
              <SubHeading text='Creative React Front-End Developer' />
              <p className="text-paralight font-poppins w-xl mb-8">
